...
Editing, deletion, reversals/corrections, credits/prepayments, returns, invoice/receipt printing, advanced accounting, payroll, forecasting, cloud sync and backup/restore remain deferred.
